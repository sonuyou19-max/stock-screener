...
BUCKET_KEYWORDS = {
    "AI_CLOUD": {
        "positive": [
            ...
            "tech rally", "nasdaq gains", "s&p gains",
        ...
        "negative": [
            ...
            "rate hike", "fed rate hike", "hawkish fed", "rates higher",
            "tech selloff", "nasdaq selloff", "tech crash",
            "ai bubble", "ai hype", "overvalued tech",
            "data center delay", "gpu shortage",
            "antitrust tech", "big tech regulation",
            "cyber breach", "data breach",
        ],
        "neutral_override": ["ai ethics", "ai safety research"],
    },

    "SEMICONDUCTORS": {
        "positive": [
            "chip demand", "semiconductor demand", "chip shortage easing",
            "nvidia earnings", "amd revenue", "tsmc revenue",
            "broadcom earnings", "qualcomm revenue",
            "chip act", "chips act", "semiconductor subsidies",
            "fab investment", "chipmaker capex",
            "ai chip demand", "gpu shortage", "hbm demand",
            "semiconductor cycle", "upcycle", "chip recovery",
            "pcb demand", "wafer demand", "foundry utilization",
            "intel turnaround", "samsung chip",
            "auto chip", "automotive semiconductor",
            "defense chip", "mil-spec semiconductor",
        ],
        "negative": [
            ...
            "tariff chips", "chip tariff", "import duty semiconductor",
            "fab delay", "chip plant delay",
            "arm miss", "qualcomm miss", "broadcom miss",
        ],
        "neutral_override": ["chip war diplomacy"],
    },

    "HIGH_GROWTH_TECH": {
        "positive": [
            "consumer spending", "retail sales beat",
            "e-commerce growth", "amazon retail", "shopify revenue",
            "fintech growth", "payment volume", "visa earnings", "mastercard earnings",
            "uber revenue", "lyft revenue", "airbnb revenue",
            "software revenue", "saas growth", "arr growth",
            "app store revenue", "digital ad revenue",
            "venture funding", "ipo market", "startup funding",
            "consumer confidence", "spending strong",
            "streaming growth", "netflix revenue",
            "rate cut", "lower rates", "growth stock rally",
        ],
        "negative": [
            "consumer slowdown", "retail miss", "spending falls",
            "e-commerce slows", "amazon miss", "shopify miss",
            "fintech regulation", "bnpl regulation",
            "uber miss", "lyft miss", "gig economy regulation",
            "ad revenue falls", "digital ad slowdown",
            "saas churn", "software spending cut",
            "recession fears", "consumer debt",
            "rate hike", "higher rates", "growth selloff",
            "ipo freeze", "startup layoffs",
        ],
        "neutral_override": ["antitrust investigation"],
    },

    "DEFENSIVE_DIV": {
        "positive": [
            "healthcare spending", "health budget", "medicare",
            "drug approval", "fda approval", "new drug approved",
            ...
            "utility earnings", "regulated utility",
            "bank earnings", "jpmorgan earnings", "bank of america",
            "safe haven", "defensive rotation", "risk off",
            "bond yield falls", "rates lower defensive",
            "insurance earnings", "health insurance",
        ...
        "negative": [
            ...
            "drug recall", "pharma penalty", "doj pharma",
            "food inflation", "commodity inflation",
            "bank failure", "bank stress", "credit crunch",
            "dividend cut", "buyback suspended",
            "utility rate rejected", "utility regulation",
            "healthcare cost rise", "medical inflation",
